...
interface EmailTemplate {
    ...
    /**
     * 비밀번호 재설정 이메일 템플릿을 생성합니다.
     *
     * @param nickname 수신자의 닉네임
     * @param passwordResetLink 비밀번호 재설정 링크
     * @param expirationHours 링크 만료 시간 (시간 단위)
     * @return 생성된 이메일 템플릿 문자열
     */
    fun buildPasswordResetEmail(nickname: String, passwordResetLink: String, expirationHours: Long): String
}
